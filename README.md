...
Rez as many screens as you need, they can all be controlled using the gestures described below or via local chat.
...
Play the `Shields Up` gesture within 10 meters of any Truth &amp; Beauty Privacy Screen and all rezzed screens in the same region owned by the same owner will activate. The texture will become visible and the screens will become solid preventing view and access.

Play the `Shields Down` gesture within 10 meters of any Truth &amp; Beauty Privacy Screen and all rezzed screens in the same region owned by the same owner will deactivate. The texture will become transparent and the screens will become phantom allowing view and access.
